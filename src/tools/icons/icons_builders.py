...
def make_icons_action(target, source, env):
    ...
    s.write("#ifndef _GDTL_ICONS_H\n")
    s.write("#define _GDTL_ICONS_H\n")
    s.write("static const int tl_icons_count = {};\n".format(len(svg_icons)))
    s.write("static const char *tl_icons_sources[] = {\n")
    s.write(icons_string.getvalue())
    s.write("};\n\n")
    s.write("static const char *tl_icons_names[] = {\n")
    ...
    if thumb_medium_indices:
        s.write("\n\n")
        s.write("static const int tl_md_thumbs_count = {};\n".format(len(thumb_medium_indices)))
        s.write("static const int tl_md_thumbs_indices[] = {")
        s.write(", ".join(thumb_medium_indices))
        s.write("};\n")
    if thumb_big_indices:
        s.write("\n\n")
        s.write("static const int tl_bg_thumbs_count = {};\n".format(len(thumb_big_indices)))
        s.write("static const int tl_bg_thumbs_indices[] = {")
