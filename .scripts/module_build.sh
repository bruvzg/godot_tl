...
git apply ./modules/godot_tl/patch_font.diff
git apply ./modules/godot_tl/patch_editor_fonts.diff
git apply ./modules/godot_tl/patch_lbl.diff
git apply ./modules/godot_tl/patch_le.diff
